		...
		<table class="table table-bordered">
			<div class="alert alert-success">Product</div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
					...
					<tbody>
						<?php 
						$query=mysql_query("select product.product_id,product.product_name,product.product_type_id,product.product_volume,product.product_description,product.product_cost,product.product_price,type.type_id,type.type_name FROM product, type WHERE product.product_type_id = type.type_id")or die(mysql_error());
						while($row=mysql_fetch_array($query)){
						?>
						<tr>
